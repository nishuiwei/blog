...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.3349ae9e.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.c4107fc7.mjs'));
...
//# sourceMappingURL=error-component.002601db.mjs.map
