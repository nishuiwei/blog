...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.a97eeee3.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.4e9fef9f.mjs'));
...
//# sourceMappingURL=error-component.597be214.mjs.map
