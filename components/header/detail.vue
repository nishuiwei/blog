			...
			<div class="h-full">
				...
				>
					<nuxt-img
						...
						provider="cloudinary"
						format="webp"
						:src="props?.mediaFile || 'v1660662530/cld-sample-2.jpg'"
						:alt="props?.title"
						:title="props?.title"
					...
					<div class="flex my-3 items-center">
						<div class="w-11 h-11 rounded-full border-2 border-dim-600">
							<nuxt-img
								...
								:src="
									props?.author?.profilePic || 'v1660662530/cld-sample-2.jpg'
								"
				...
				<div class="flex my-3 items-center">
					<div class="w-11 h-11 rounded-full border-2 border-dim-600">
						<nuxt-img
							...
							format="webp"
							v-if="props?.author?.profilePic"
							:src="props?.author?.profilePic || 'v1660662530/cld-sample-2.jpg'"
							:alt="props?.author?.username"
							:title="props?.author?.username"
							:aria-label="props?.author?.username"
							class="rounded-full w-full h-full object-cover"
